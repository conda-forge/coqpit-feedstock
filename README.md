...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/coqpit-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14158&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/coqpit-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `coqpit` can be installed with:

```
conda install coqpit
```

It is possible to list all of the versions of `coqpit` available on your platform with:
